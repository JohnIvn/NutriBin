...
function AdminModal({ mode, cancel }) {
	...
	async function onSubmit(values) {
		...
		try {
			...
			// const response = await Requests('/auth/signup', 'post', formData)
			const response = await axios.post('http://localhost:3000/staff/signup', formData)
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Input placeholder="email123@gmail.com" className={'border border-secondary-foreground'} {...field} />
											</FormControl>
											<FormMessage />
										</FormItem>
									)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormControl>
													<Input type={'date'} className={'border border-secondary-foreground'} {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
